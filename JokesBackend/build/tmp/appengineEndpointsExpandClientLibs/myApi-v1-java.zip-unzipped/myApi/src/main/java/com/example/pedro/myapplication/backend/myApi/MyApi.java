...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://built-it-bigger.appspot.com/_ah/api/";
  ...
  public class GetJokes extends MyApiRequest<com.example.pedro.myapplication.backend.myApi.model.MyBean> {
     ...
     */
    protected GetJokes() {
      super(MyApi.this, "GET", REST_PATH, null, com.example.pedro.myapplication.backend.myApi.model.MyBean.class);
    }
